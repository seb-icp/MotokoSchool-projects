import { CallOptions, JsonObject, Principal, QueryFields, QueryResponse, ReadStateOptions, ReadStateResponse, SubmitResponse } from '@dfinity/agent';
import { Agent } from '@dfinity/agent/lib/cjs/agent/api';
